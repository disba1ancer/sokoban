...
#include <util/util.h>
#include <sokoban/Terminal_priv.h>
...
void Terminal::attach(EventType eventType, util::IConnection<void(util::Event&)>& con) {
        auto& pthis = PRIVATE;
        return pthis.events.at(eventType).addConnection(&con);
}
